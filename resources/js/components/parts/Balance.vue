<template>
    <transition name="fade">
        <section class="balance" v-if="!loading">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="balance__title">Счёт текущего месяца:</div>
                        <div class="balance__value">{{ balance | priceFormat(balance) }} <span class="balance__currency">₽</span></div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-6">
                            <div class="balance__card">
                                <div class="balance__card-info">
                                    ...
                                    <div class="balance__card-value">{{ plus | priceFormat(plus) }} <span class="balance__card-currency">₽</span></div>
                                </div>
                        ...
                        <div class="col-6">
                            <div class="balance__card">
                                <div class="balance__card-info">
                                    ...
                                    <div class="balance__card-value">{{ minus | priceFormat(minus) }} <span class="balance__card-currency">₽</span></div>
                                </div>
                                <div class="balance__card-icon">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0)">
